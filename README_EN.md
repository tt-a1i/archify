...
HTML is the default. SVG requires `--format svg` and a `.svg` path; `--theme auto|light|dark` selects colours. See the [delivery contract](archify/references/delivery-contract.md).
