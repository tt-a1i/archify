...
Archify is a Node.js rendering and validation system for Cursor, Claude Code, Codex CLI, OpenCode, and WorkBuddy. Agents produce typed JSON IR; Archify deterministically compiles it into HTML/SVG.
