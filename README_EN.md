...
| **Claude Code** | `tt-a1i/archify` plugin `archify`, or `npx skills add` | Full renderer + validation workflow |
| **Codex CLI** | `archify@archify` via `tt-a1i/archify`, or `npx skills add` | Full renderer + validation workflow |
