...
<table>
  ...
  <tr><td align="center" width="240"><a href="https://termio.sh"><img src="docs/assets/sponsors/termio-archify.png" alt="Archify × Termio" width="200" /></a><br/><strong><a href="https://termio.sh">Termio</a></strong></td><td>Termio sponsors Archify and builds the terminal-first agentic development environment: a free, open-source native Mac app where <a href="https://github.com/termio-sh/termio"><strong>Claude Code, Codex, OpenCode</strong></a> and other coding agents run side by side in real terminals, on machines you own.</td></tr>
</table>
