...
- **打开就是成品** —— 五种技术图、四套视觉预设、深浅主题、内置品牌与中性能力标记，以及显式启用的有限动态
...
[MIT](LICENSE) —— 可以自由使用、修改和分发。第三方品牌名称、Logo、商标和图形素材
不属于 Archify MIT 许可范围；详见随包提供的[第三方品牌素材声明](archify/THIRD_PARTY_BRAND_ASSETS.md)。
