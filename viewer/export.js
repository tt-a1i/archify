...
/* ARCHIFY:EXPORT_CLEANUP */
      ...
      Archify.exportMenu = {
        ...
        isOpen: isOpen,
        run: runExport,
        // Same serialization "Download SVG" uses, returned as a value instead
        // of a browser download so a headless caller can obtain the standalone
        // document. Default matches the menu item (dual-theme); autoTheme:false
        // locks the SVG to the viewer's current theme.
        svgDocument: function (options) {
          options = options || {};
          return serializeSvg(1, { autoTheme: options.autoTheme !== false });
        },
