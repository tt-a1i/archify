...
const CASES = [
  ...
  },
  {
    ...
    output: 'transformer-layer.architecture.html',
    focus: 'transformer',
    view: 'transformer-layer',
    accent: '#22d3ee',
    titleEn: 'Transformer Layer Internals',
    titleZh: 'Transformer 层内部架构',
    descriptionEn: 'The complete parent model stays unchanged while one authored local graph reveals attention, feed-forward, and exact residual paths on demand.',
    descriptionZh: '完整父图保持不变，并按需打开一层局部图，准确展示 Attention、前馈网络和残差路径。',
  },
  {
    id: 'cache-miss',
    type: 'sequence',
