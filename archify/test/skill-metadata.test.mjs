...
test('language behavior stays within the bounded locale contract', () => {
  ...
  assert.match(skill, /use `"en"`, `"zh-CN"` \(Simplified Chinese\), or `"zh-TW"` \(Traditional Chinese\)/);
  ...
  assert.match(authoringContract, /outside `en`, `zh-CN`, and `zh-TW`/);
  assert.match(authoringContract, /never substitute `zh-CN`\s+for `zh-TW` or the reverse/);
