...
const MESSAGE_PAIRS = {
  ...
  'legend.erd.pk': ['Primary key', '主键'],
  'legend.erd.fk': ['Foreign key', '外键'],
  'legend.erd.uk': ['Unique key', '唯一键'],
  'legend.erd.one': ['One', '一'],
  'legend.erd.many': ['Many', '多'],
  'legend.erd.optional': ['Optional', '可选'],
