...
const MESSAGE_PAIRS = {
  ...
  'viewer.passport.drilldowns': ['Child diagrams', '子图'],
  'viewer.passport.drilldowns.list': ['Open a child diagram', '打开子图'],
  'viewer.passport.drilldowns.hint': ['Ctrl+click or double-click opens the first entry', 'Ctrl+单击或双击打开列表第一项'],
  'viewer.passport.drilldowns.open': ['Open {label}', '打开{label}'],
  'viewer.passport.back': ['Back to parent', '返回上一级'],
  'viewer.passport.back.aria': ['Return to the parent diagram', '返回父级图'],
  'viewer.nav.back': ['Back', '返回'],
  'viewer.nav.back.title': ['Return to the parent diagram', '返回父级图'],
