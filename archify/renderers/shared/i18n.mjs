...
const MESSAGE_PAIRS = {
  ...
  'diagram.description.erd': ['An entity-relationship diagram generated by Archify.', '由 Archify 生成的实体关系图。'],
  ...
  'legend.erd.transactional': ['Transactional entity', '事务实体'],
  'legend.erd.reference': ['Reference entity', '引用实体'],
  'legend.erd.event': ['Event entity', '事件实体'],
  'legend.erd.junction': ['Junction entity', '关联实体'],
  'legend.erd.external': ['External entity', '外部实体'],
