...
const MESSAGE_PAIRS = {
  ...
  'viewer.export.target': ['Export target', '导出范围'],
  'viewer.export.target.main': ['Main architecture', '主架构'],
  'viewer.export.target.main.hint': ['Complete top-level graph', '完整的顶层架构图'],
  'viewer.export.target.subarchitecture': ['Current subarchitecture', '当前子架构'],
  'viewer.export.target.subarchitecture.hint': ['Internal graph only', '仅导出内部架构图'],
  'viewer.export.target.subarchitectureUnavailable': ['Open an internal architecture first', '请先打开一个子架构'],
  ...
  'viewer.export.error.subarchitectureUnavailable': ['The selected subarchitecture is no longer available', '所选子架构已不可用'],
  ...
  'viewer.subarchitecture.trigger': ['Open internal architecture', '打开内部架构'],
  'viewer.subarchitecture.triggerFor': ['View internals for {label}', '查看{label}的内部架构'],
  'viewer.subarchitecture.disclosures': ['Expandable internal architectures', '可展开的内部架构'],
  'viewer.subarchitecture.available': ['Internal architecture available', '可查看内部架构'],
  'viewer.subarchitecture.expand': ['EXPAND ↓', '展开 ↓'],
  'viewer.subarchitecture.collapse': ['COLLAPSE ↑', '收起 ↑'],
  'viewer.subarchitecture.eyebrow': ['Local architecture', '局部架构'],
  'viewer.subarchitecture.title': ['Component internals', '组件内部架构'],
  'viewer.subarchitecture.back': ['← Back to model', '← 返回主模型'],
  'viewer.subarchitecture.close': ['Close internals', '关闭内部架构'],
  'viewer.subarchitecture.stage': ['Internal component graph', '组件内部关系图'],
  'viewer.subarchitecture.passport.emptyTitle': ['Select a component', '选择一个组件'],
  'viewer.subarchitecture.passport.empty': ['Select a component to inspect its local input and output relationships.', '选择一个组件以检查其局部输入和输出关系。'],
  'viewer.subarchitecture.passport.metadata': ['Local node metadata', '局部节点元数据'],
  'viewer.subarchitecture.passport.copy': ['Copy local link', '复制局部链接'],
  'viewer.subarchitecture.passport.relations': ['Local relationships', '局部关系'],
  'viewer.subarchitecture.unavailable': ['Internal architecture unavailable', '内部架构不可用'],
