...
const MESSAGE_PAIRS = {
  ...
  'viewer.passport.approval.title': ['Approval details', '审批详情'],
  'viewer.passport.approval.available': ['Approval details available', '可查看审批详情'],
  'viewer.passport.approval.approverCount.one': ['{count} approver', '{count} 位审批人'],
  'viewer.passport.approval.approverCount.other': ['{count} approvers', '{count} 位审批人'],
  'viewer.passport.approval.deliverableCount.one': ['{count} deliverable', '{count} 项交付物'],
  'viewer.passport.approval.deliverableCount.other': ['{count} deliverables', '{count} 项交付物'],
  'viewer.passport.approval.initiator': ['Initiator', '发起人'],
  'viewer.passport.approval.approvers': ['Approvers', '审批人'],
  'viewer.passport.approval.deliverables': ['Required deliverables', '必需交付物'],
  'viewer.passport.approval.rework': ['Rework path', '返工路径'],
  'viewer.passport.approval.exportScope': ['Visual exports show the overview only; approval details remain in this HTML artifact.', '视觉导出仅显示概览；审批详情保留在此 HTML 文件中。'],
