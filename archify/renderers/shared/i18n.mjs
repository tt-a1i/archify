...
const MESSAGE_PAIRS = {
  ...
  'viewer.lens.instruction': ['Choose one kind to inspect, or up to four kinds for a bounded role comparison. Comparisons use only direct authored relationships.', '选择一种类型进行检查，或最多选择四种类型进行有界角色比较。比较只使用直接编写的关系。'],
  ...
  'viewer.lens.multi': ['Role comparison: {kinds} kinds · {relationships} direct relationships · selected nodes remain distinct', '角色比较：{kinds} 种类型 · {relationships} 条直接关系 · 所选节点保持区分'],
