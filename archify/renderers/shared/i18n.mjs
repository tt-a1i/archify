...
const MESSAGE_PAIRS = {
  ...
  'viewer.preset.salesforce': ['Soft Cloud', '柔和云端'],
  'viewer.preset.salesforce.hint': ['Calm, customer-friendly documentation', '平静、面向客户的文档'],
  ...
  'viewer.preset.badge.salesforce': ['SOFT CLOUD', '柔和云端'],
