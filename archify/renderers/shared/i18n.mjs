...
const MESSAGE_PAIRS = {
  ...
  'viewer.preset.blossom': ['Blossom', '花开'],
  'viewer.preset.blossom.short': ['Blossom', '花开'],
  'viewer.preset.blossom.hint': ['Warm personal showcase', '个人作品展示'],
  ...
  'viewer.preset.badge.blossom': ['BLOSSOM', '花开'],
