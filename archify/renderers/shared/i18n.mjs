...
const MESSAGE_PAIRS = {
  ...
  'viewer.passport.details': ['Details', '详情'],
  'viewer.passport.details.show': ['Show full semantic passport', '展开完整语义护照'],
  'viewer.passport.details.hide': ['Return to compact relationship exploration', '返回紧凑关系探索'],
