...
- **Open it and present** — five diagram types, four presets, dark/light themes, built-in brand/capability marks, and finite motion
...
Archify code is [MIT-licensed](LICENSE). Third-party marks are excluded; see the
packaged [brand asset notice](archify/THIRD_PARTY_BRAND_ASSETS.md).
