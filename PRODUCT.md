...
5. Portable proof: the default result is a self-contained artifact with deterministic validation and no required hosted runtime; visual exports preserve the complete authored topology and do not pretend to be validation evidence.
